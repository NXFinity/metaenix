...
export const authService = {
   ...
   * @returns Session token and expiration for admin client
   */
  async createAdminSession(): Promise<{ sessionToken: string; expiresAt: string }> {
    const response = await apiClient.post<{ sessionToken: string; expiresAt: string }>(
