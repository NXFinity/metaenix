...
export const POSTS_ENDPOINTS = {
   ...
   * GET /shares/posts?page=1&limit=20
   */
  GET_SHARES: '/shares/posts',
   ...
   * GET /posts/collections?page=1&limit=20
   */
  GET_COLLECTIONS: '/posts/collections',
  ...
  /**
   * Update a collection
   * PATCH /posts/collections/:collectionId
   */
  UPDATE_COLLECTION: (collectionId: string) =>
    `/posts/collections/${collectionId}`,
