...
export interface Comment {
  ...
  repliesCount: number;
  isLiked?: boolean;
  resourceType: string; // 'post', 'video', 'photo', 'article', etc.
  resourceId: string; // ID of the resource (post, video, etc.)
  postId?: string; // Legacy field for backward compatibility
  userId: string;
